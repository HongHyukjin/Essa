                            ...
                            <div className="mypage-update">
                                ...
                                <div className="update-form">
                                    <div className="mypage-inf">
                                        <form action="" name='formJoin' id='formJoin'>
                                                    ...
                                                    <table border="0" cellPadding="0" cellSpacing="0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" name='' id='' value="marinoma"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>
                                                            ...
                                                            <tr>
                                                                <th><span>이름</span></th>
                                                                <td>
                                                                    <input type="text" name='' id='' value="유영현"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>
                                                                ...
                                                                <td>
                                                                    <input type="text" name='' id='' value="marinoma@naver.com" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>
                                                                ...
                                                                <td>
                                                                    <input type="text" name='' id='' value="01071639140"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>
                                                                ...
                                                                <td>
                                                                    <div className="member-birth">
                                                                        <select className='chosen-single' name="birthYear" style={{width:"100px"}} >
                                                                    ...
                                                                    <div className="member-birth">
                                                                        <select className='chosen-single' name="birthYear" style={{width:"80px"}}>
                                                                    ...
                                                                    <div className="member-birth">
                                                                        <select className='chosen-single' name="birthYear" >
